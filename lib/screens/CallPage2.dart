...
class CallPageSecond extends StatefulWidget {
  ...
  @override
  CallPageSecondState createState() {
    return new CallPageSecondState(
      appId: appId,
      channel: channel,
      video: video,
      audio: audio,
...
class CallPageSecondState extends State<CallPageSecond> {
  String appId;
  String channel;
  bool video;
  bool audio;
