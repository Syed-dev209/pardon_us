...
class _SendVideoState extends State<SendVideo> {
 ...
 playVideo(){
   _videoPlayerController = VideoPlayerController.file(widget._video)..initialize().then((_){
     setState(() {});
   });
 }
@override
        ...
        floatingActionButton: GestureDetector(
          ...
          onTap: ()async{
            ...
            try {
              ...
              bool check= await sendVideo.sendVideo(widget._video, widget.senderName, widget.classCode);
              if(check) {
                setState(() {
