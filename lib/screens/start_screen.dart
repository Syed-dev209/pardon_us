    ...
    return WillPopScope(
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: SafeArea(child: Consumer<UserDetails>(
                ...
                builder: (context, snapshot) {
                  ...
                  for (var cd in classData) {
                    ...
                    if (classTeacher == user.username) {
                      ...
                      studentClasses.add(buildListTile(user.username, classCode,
                          classTitle, classTeacher, 'Student', classImage));
                    }
                  }
                  return Column(
                    children: [
                      ...
                      Classes(
                          _queryData.size.width,
                          'https://www.kindpng.com/picc/m/109-1097640_student-university-cartoon-hd-png-download.png',
                          'MY COURSES',
                          studentClasses)
                    ],
                  );
